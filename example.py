...
packer = Packer()
#  init bin
box1 = Bin('Box1',(25, 10, 15), 100,0,0)
...
packer.addItem(Item('test1', 'test','cube',(9, 8, 7), 1, 6, 100, True,'red'))
packer.addItem(Item('test2', 'test','cube',(4, 25, 1), 1, 5, 100, True,'blue'))
packer.addItem(Item('test3', 'test','cube',(2, 13, 5), 1, 4, 100, True,'gray'))
packer.addItem(Item('test4', 'test','cube',(7, 5, 4), 1, 3, 100, True,'orange'))
packer.addItem(Item('test5', 'test','cube',(10, 5, 2), 1, 2, 100, True,'lawngreen'))
packer.addItem(Item('test6', 'test','cube',(6, 5, 2), 1, 1, 100, True,'purple'))
packer.addItem(Item('test7', 'test','cube',(5, 2, 9), 1, 7, 100, True,'yellow'))
